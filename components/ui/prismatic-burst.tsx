...
// Adaptado do componente PrismaticBurst (React Bits). Mesma logica de shader
// e ciclo de vida do original; so a tipagem foi apertada (sem `as any`/`as
// Window`) para bater com o eslint estrito do projeto.
