...
// forcada pra tons de cinza (ver `colors` em Pricing.tsx) pra caber no
// sistema monocromatico do site (nada de cor, so branco em opacidades).
//
// ATENCAO DE PESO: isso e MUITO mais pesado que uma animacao CSS (e o que
// tinha antes, FloatingPathsBackground) — e um shader fragment rodando
// raymarching (44 passos por pixel) no canvas inteiro, todo frame, via
// WebGL. O componente ja pausa sozinho quando sai da tela (IntersectionObserver)
// ou a aba fica em background (document.hidden), o que ajuda, mas em
// notebooks fracos/integrados o custo de GPU pode ainda ser sensivel. Se
// isso voltar a pesar, os botoes mais diretos sao: reduzir `rayCount`,
// reduzir `intensity`, ou trocar por um dpr mais baixo aqui dentro
